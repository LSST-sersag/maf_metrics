...
class AgnVariabilityMetrics:
    ...
    def runAll(self):
        ...
        print('')
        print('1) Heatmaps of deviation of SFs for selected OpSim cadence. Colorbar represents deviations. Positive deviations stand for SFs when values of homogeneous curve are larger than SF of gaped curve in average per bin and vice versa.')
        self.plot_heatmap()
