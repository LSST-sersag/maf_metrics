...
class StructureFunctionAgnMetric:
    ...
    frame='observed'
    nlc=1
    name = "StructureFunctionAgnMetric"
    ...
    def plot_heatmap ( self, label = "Heatmap", lb='map', save=True, cmap='RdBu_r', c=30,  err='squared'):
        ...
        ax2.set_title('OPSIM: %s' %(label)+', RA: %s' %(self.ra)+', DEC: %s' %(self.dec)+', FILT: %s' %(self.fil), fontsize=12)
